...
LeaderboardHandler::LeaderboardHandler()
{
    ...
    leaderboard_names.push_back("Training1");
    leaderboard_names.push_back("Training2");
    leaderboard_names.push_back("Training3");
    leaderboard_names.push_back("Training4");
    leaderboard_names.push_back("Training5");
    leaderboard_names.push_back("Training6");
    leaderboard_names.push_back("A");
    leaderboard_names.push_back("B");
    leaderboard_names.push_back("C");
    leaderboard_names.push_back("D");
    leaderboard_names.push_back("E");
    leaderboard_names.push_back("F");
    leaderboard_names.push_back("A1");
    leaderboard_names.push_back("A2");
    leaderboard_names.push_back("A3");
    leaderboard_names.push_back("B1");
    leaderboard_names.push_back("B2");
    leaderboard_names.push_back("B3");
    leaderboard_names.push_back("C1");
    leaderboard_names.push_back("C2");
    leaderboard_names.push_back("C3");
    leaderboard_names.push_back("C1");
    leaderboard_names.push_back("C2");
    leaderboard_names.push_back("C3");
    leaderboard_names.push_back("D1");
    leaderboard_names.push_back("D2");
    leaderboard_names.push_back("D3");
    leaderboard_names.push_back("E1");
    leaderboard_names.push_back("E2");
    leaderboard_names.push_back("E3");
    leaderboard_names.push_back("F1");
    leaderboard_names.push_back("F2");
    leaderboard_names.push_back("F3");
    for(int i=1;i<=24;i++)
    {
        string leaderboard_name = "X"+rosalila()->utility->toString(i);
        leaderboard_names.push_back(leaderboard_name.c_str());
    }
    for(int i=1;i<=5;i++)
    {
...
int LeaderboardHandler::getLeaderboardDownloadPercentage()
{
  double downloaded_double = (double)downloaded_leaderboards;
  double total_double = (double)this->leaderboard_names.size();
  return (downloaded_double/total_double)*100.0;
}
